...
- **`roofus-cold-breath-test-lp.html`** — cold-traffic "diagnosis" page (this variant). Problem-first, buy box in the lower third, built for cold / problem-unaware traffic. Assets live in `assets/`.
